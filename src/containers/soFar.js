                        ...
                        <div class="row">
                            <div class="col s12 m12 l12">
                                ...
                                <MDBAnimation reveal type="fadeInUp">
                                    <p className='aboutMeP'>I have been working as a full-time Front-end Engineer at <a href="https://carshair.com" className="testimonialLink" target="_blank">carShair</a>, a startup providing a peer-to-peer platform for car rentals.  I managed to grow my technical experience (in MERN technologies) by solving and optimizing various types of tasks following industrial-level standards.</p>
                                    <p className="aboutMeP">I graduated with an M.Sc. degree in Computer Science from <a href="http://uwo.ca" className="testimonialLink" target="_blank">the University of Western Ontario</a> in 2021. My research focus is information visualization, human-information interaction, Visual Analytics Systems' interaction and interactivity, and scientific documents analysis (ML and NLP approaches).</p>
                                    <p className="aboutMeP">Before starting my Master's program in Canada, I was a React Native developer in <a href="http://rayanpajouh.co/" className="testimonialLink" target="_blank">Rayan Pajouh Co.</a> in Tehran, Iran. I was focused on the design and development of healthcare and medical mobile applications. Some of my major contributions and Projects have been mentioned in the Portfolio section.</p>
                                    <p className="aboutMeP">I got my B.Sc. degree in Computer Engineering from <a href="https://khu.ac.ir/en" className="testimonialLink" target="_blank">Kharazmi University</a> in 2019. Aside from the valuable courses, I attended during the program, teaching web and mobile application development, holding volunteer seminars and workshops, participating in <a href="https://tophpc.com/" className="testimonialLink" target="_blank">TopHPC congress</a> as an executive member were some of my precious experiences that shaped my professional personality.</p>
